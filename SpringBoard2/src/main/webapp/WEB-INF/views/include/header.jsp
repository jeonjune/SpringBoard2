    ...
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="${pageContext.request.contextPath }/resources/index2.html" class="logo">
          ...
          <span class="logo-lg"><b>JUNE</b> PROJECT</span>
        </a>
          ...
          <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <img src="../resources/증명1.jpg" class="user-image" alt="User Image"/>
                  <span class="hidden-xs">전지윤</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
        ...
        <section class="sidebar">
          ...
          <div class="user-panel">
            <div class="pull-left image">
              <img src="../resources/증명1.jpg" class="img-circle" alt="User Image" />
            </div>
